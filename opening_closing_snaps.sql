...
-- Explanation:
-- Using the age bucket 26-30 as an example, the time spent sending snaps was 5.67 and the time spent opening snaps was 3.
...
WITH CTE AS (
    SELECT 
        ab.age_bucket,
        SUM(CASE WHEN a.activity_type = 'send' THEN time_spent ELSE 0 END) AS sent_time,
...
SELECT 
    age_bucket, 
    ROUND(sent_time * 100.0 / total_time, 2) AS send_perc,
